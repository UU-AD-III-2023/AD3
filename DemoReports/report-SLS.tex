...
We fine-tuned the local-search parameters as follows. We ran the executable a few times with certain inputs, where each set of parameters $\alpha$ and $\beta$ and took the configuration, where it timed out the least. 
%
