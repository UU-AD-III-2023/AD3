...
%\newcommand{\todo}[1]{#1}               % show to-do items in black
\newcommand{\done}[1]{{\color{red}#1}}   % show done  items in red
...
\title{\textbf{Algorithms and Data Structures III (course 1DL481) \\
    ...
    Report for Assignment 1  %% Replace n by 1 or 2
...
% \clearpage
% \input{report-SAT.tex}

% %% Comment away for Assignment 1:
% \clearpage
% \input{report-SMT.tex}

%\clearpage
\section*{Feedback to the Teachers}

The help sessions were very helpful, as sometimes the task were not very clear. The demo report with the clear structure was very helpful in what to do and what to write. 
